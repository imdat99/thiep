  ...
  return (
    <div id="SECTION3" className="ladi-section">
      ...
      <div className="ladi-container">
        ...
        <div id="GROUP5" className="ladi-element ladi-animation">
        ...
        <div id="GROUP23" className="ladi-element ladi-animation">
          <div className="ladi-group">
        ...
        <div id="HEADLINE48" className="ladi-element ladi-animation">
          <p className="ladi-headline ladi-transition">
            Thân mời tới dự lễ cưới thân mật của chúng tôi
            <br />
          </p>
        </div>
        <div id="HEADLINE49" className="ladi-element ladi-animation">
        ...
        <a
          href="https://maps.app.goo.gl/LXqnAodCVyVpJqtL6"
          target="_blank"
          id="GROUP10"
          className="ladi-element ladi-animation"
          data-replace-href="https://maps.app.goo.gl/LXqnAodCVyVpJqtL6"
        >
          <div className="ladi-group">
        ...
        <div id="HEADLINE108" className="ladi-element ladi-animation">
          <p className="ladi-headline ladi-transition">
            Trường mầm non Hoàng Nông
            <br />
          </p>
        </div>
        <div id="HEADLINE109" className="ladi-element ladi-animation">
          <p className="ladi-headline">
            Địa chỉ: xóm La Lương - Hoàng Nông - Đại Từ - Thái Nguyên
          </p>
        </div>
        ...
        <div id="GROUP30" className="ladi-element">
          <div className="ladi-group">
            <div id="HEADLINE103" className="ladi-element ladi-animation">
              <p className="ladi-headline">
                (Tức ngày 21 tháng 04 năm Ất Tỵ)
                <br />
              </p>
            </div>
            <div id="HEADLINE104" className="ladi-element ladi-animation">
              <p className="ladi-headline">chủ nhật</p>
            </div>
            <div id="HEADLINE105" className="ladi-element ladi-animation">
              <p className="ladi-headline">18</p>
            </div>
            <div id="GROUP31" className="ladi-element ladi-animation">
              <div className="ladi-group">
                ...
                <div id="HEADLINE106" className="ladi-element ladi-animation">
                  <p className="ladi-headline ladi-transition">
                    tháng 5<br />
                  </p>
                </div>
                <div id="LINE10" className="ladi-element">
                  <div className="ladi-line">
                    <div className="ladi-line-container" />
                  </div>
                </div>
            ...
            <div id="GROUP32" className="ladi-element ladi-animation">
              <div className="ladi-group">
                <div id="LINE11" className="ladi-element">
                  <div className="ladi-line">
                    <div className="ladi-line-container" />
                  </div>
                </div>
                <div id="HEADLINE107" className="ladi-element ladi-animation">
                  <p className="ladi-headline ladi-transition">
                    năm 2025
                    <br />
                  </p>
                </div>
                <div id="LINE12" className="ladi-element">
                  <div className="ladi-line">
                    <div className="ladi-line-container" />
                  </div>
                </div>
        ...
        <div id="GROUP43" className="ladi-element">
          <div className="ladi-group">
            <div id="LINE13" className="ladi-element">
              <div className="ladi-line">
                <div className="ladi-line-container" />
              </div>
            </div>
            ...
            <div id="GROUP42" className="ladi-element">
              <div className="ladi-group">
        ...
        <div id="IMAGE54" className="ladi-element">
          <div className="ladi-image">
            <div className="ladi-image-background" />
          </div>
        </div>
        ...
        <div id="GROUP46" className="ladi-element">
          <div className="ladi-group">
            <div id="HEADLINE121" className="ladi-element ladi-animation">
              <p className="ladi-headline ladi-transition">Tháng 10</p>
            </div>
            ...
            <div id="IMAGE56" className="ladi-element ladi-animation">
              <div className="ladi-image">
                <div className="ladi-image-background" />
              </div>
            </div>
        ...
        <div id="BOX37" className="ladi-element">
          <div className="ladi-box ladi-transition" />
        </div>
        <div id="GROUP50" className="ladi-element">
          <div className="ladi-group">
            <div id="HEADLINE196" className="ladi-element ladi-animation">
              <p className="ladi-headline ladi-transition">Tháng 11</p>
            </div>
            ...
            <div id="IMAGE58" className="ladi-element ladi-animation">
              <div className="ladi-image">
                <div className="ladi-image-background" />
              </div>
            </div>
            ...
            <div id="HEADLINE233" className="ladi-element">
              <p className="ladi-headline ladi-transition">
                23
                <br />
              </p>
